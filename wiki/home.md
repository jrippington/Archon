...
4. [Roslyn semantic extraction](roslyn-semantic-extraction.md) explains the current compiler-backed C# declaration extraction slice, semantic stable keys, evidence, and containment facts.
