namespace Archon.Infrastructure.Roslyn
{
    /// <summary>
    /// Identifies the Archon.Infrastructure.Roslyn project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonInfrastructureRoslynProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonInfrastructureRoslynProjectMarker"/> class.
        /// </summary>
        public ArchonInfrastructureRoslynProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Infrastructure.Roslyn";
        }
    }
}
