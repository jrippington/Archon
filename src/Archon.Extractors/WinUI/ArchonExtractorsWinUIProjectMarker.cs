...
{
    /// <summary>
    /// Identifies the Archon.Extractors WinUI category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsWinUIProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsWinUIProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsWinUIProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.WinUI";
        }
    }
}
