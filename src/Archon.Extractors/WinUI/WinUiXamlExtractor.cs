...
{
    /// <summary>
    /// Extracts static UI extraction WinUI XAML and packaging facts from project files, manifests, XAML markup, and code-behind source into shared graph contracts.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class WinUiXamlExtractor
    {
        ...
        {
            // Unknown extraction focuses on runtime patterns called out by static UI extraction rather than attempting to model every WinUI dynamic feature.
        ...
        {
            // Metadata uses shared static UI extraction artifact names rather than WinUI-specific graph node kinds.
