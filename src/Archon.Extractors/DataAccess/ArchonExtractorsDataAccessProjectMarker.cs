namespace Archon.Extractors.DataAccess
{
    /// <summary>
    /// Identifies the Archon.Extractors DataAccess category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsDataAccessProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsDataAccessProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsDataAccessProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.DataAccess";
        }
    }
}
