namespace Archon.Extractors.Projects
{
    /// <summary>
    /// Identifies the Archon.Extractors Projects category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsProjectsProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsProjectsProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsProjectsProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.Projects";
        }
    }
}
