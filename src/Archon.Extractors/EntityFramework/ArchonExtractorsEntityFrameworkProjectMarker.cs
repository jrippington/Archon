namespace Archon.Extractors.EntityFramework
{
    /// <summary>
    /// Identifies the Archon.Extractors EntityFramework category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsEntityFrameworkProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsEntityFrameworkProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsEntityFrameworkProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.EntityFramework";
        }
    }
}
