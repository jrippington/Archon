...
{
    /// <summary>
    /// Identifies the Archon.Extractors Avalonia category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsAvaloniaProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsAvaloniaProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsAvaloniaProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.Avalonia";
        }
    }
}
