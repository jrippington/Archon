...
{
    /// <summary>
    /// Extracts modern appsettings JSON keys and compiler-bound modern configuration API usage into configuration graph contracts.
    /// </summary>
    public sealed class ModernConfigurationExtractor
    {
        ...
        {
            // Type endpoints keep the first configuration slice aligned with configuration reusable node kinds.
