...
{
    /// <summary>
    /// Identifies the Archon.Extractors Configuration category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsConfigurationProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsConfigurationProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsConfigurationProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.Configuration";
        }
    }
}
