...
{
    /// <summary>
    /// Identifies the Archon.Extractors WinForms category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsWinFormsProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsWinFormsProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsWinFormsProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.WinForms";
        }
    }
}
