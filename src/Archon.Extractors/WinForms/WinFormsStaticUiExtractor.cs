...
{
    /// <summary>
    /// Extracts static UI extraction Windows Forms static UI facts from project, source, designer, and resource files into shared graph contracts.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class WinFormsStaticUiExtractor
    {
        ...
        {
            // Events become command-style facts so UI interactions can be queried through the same relationship vocabulary used by earlier static UI extraction slices.
        ...
        {
            // Metadata uses shared static UI extraction artifact names rather than Windows Forms-specific graph node kinds.
