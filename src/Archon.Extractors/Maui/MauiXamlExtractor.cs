...
{
    /// <summary>
    /// Extracts static UI extraction .NET MAUI XAML, Shell, platform-head, navigation, and dependency facts from repository source into shared graph contracts.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class MauiXamlExtractor
    {
        ...
        {
            // Unknown extraction focuses on runtime patterns called out by static UI extraction rather than attempting to model every MAUI dynamic feature.
        ...
        {
            // Metadata uses shared static UI extraction artifact names rather than MAUI-specific graph node kinds.
