...
namespace Archon.Extractors.AspNet.Runtime
{
    ...
    public sealed class NonHttpRuntimeConsumerExtractor
    {
        ...
        {
            // Work Item 6 currently implements C# source-pattern extraction because the existing runtime orchestration loads C# semantic inputs for runtime consumers.
        ...
        {
            // Search names are upper-invariant to match the existing graph-node pattern used by runtime extractors.
