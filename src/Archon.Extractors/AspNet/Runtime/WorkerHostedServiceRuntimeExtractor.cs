...
namespace Archon.Extractors.AspNet.Runtime
{
    ...
    public sealed class WorkerHostedServiceRuntimeExtractor
    {
        ...
        {
            // Dependency-injection extraction stores hosted-service registration detail on REGISTERED_AS_SERVICE edges, so correlation reads edge metadata without depending on extractor internals.
        ...
        {
            // HostedService is a first-class runtime node kind, with runtimeKind distinguishing hosted and background-service subtypes.
        ...
        {
            // Runtime extraction scopes hosted-service identity by project plus fully qualified implementation type name.
