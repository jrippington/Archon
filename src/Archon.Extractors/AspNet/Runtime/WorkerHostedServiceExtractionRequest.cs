...
namespace Archon.Extractors.AspNet.Runtime
{
    ...
    public sealed class WorkerHostedServiceExtractionRequest
    {
        ...
        /// <param name="priorSnapshot">The optional already-accumulated snapshot used to correlate runtime facts with dependency-injection facts.</param>
        ...
        /// <summary>
        /// Gets the optional already-accumulated snapshot used to correlate runtime facts with dependency-injection facts.
        /// </summary>
