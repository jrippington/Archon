namespace Archon.Extractors.AspNet
{
    /// <summary>
    /// Identifies the Archon.Extractors AspNet category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsAspNetProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsAspNetProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsAspNetProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.AspNet";
        }
    }
}
