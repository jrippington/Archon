...
{
    /// <summary>
    /// Identifies the Archon.Extractors Blazor category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsBlazorProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsBlazorProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsBlazorProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.Blazor";
        }
    }
}
