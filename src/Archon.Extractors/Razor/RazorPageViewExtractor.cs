...
{
    /// <summary>
    /// Extracts static UI extraction Razor Pages and MVC Razor view facts from static `.cshtml` files into shared graph contracts.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class RazorPageViewExtractor
    {
        ...
        {
            // Artifact kind follows the shared UI metadata vocabulary from static UI extraction.
