...
{
    /// <summary>
    /// Identifies the Archon.Extractors DependencyInjection category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsDependencyInjectionProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsDependencyInjectionProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsDependencyInjectionProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.DependencyInjection";
        }
    }
}
