...
{
    /// <summary>
    /// Identifies the Archon.Extractors LegacyWeb category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsLegacyWebProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsLegacyWebProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsLegacyWebProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Extractors.LegacyWeb";
        }
    }
}
