...
{
    /// <summary>
    /// Identifies the Archon.Extractors Wpf category in the consolidated extractor project.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonExtractorsWpfProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonExtractorsWpfProjectMarker"/> class.
        /// </summary>
        public ArchonExtractorsWpfProjectMarker()
        {
