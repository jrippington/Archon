namespace Archon.Extractors.Integrations
{
    ...
    /// </summary>
    /// <remarks>
    /// Marker types let tests and host composition verify project references without coupling to an implementation class whose responsibility may move as the integration extractor grows.
    /// </remarks>
