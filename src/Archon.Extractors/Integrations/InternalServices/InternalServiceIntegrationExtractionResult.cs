...
{
    /// <summary>
    /// Contains the partial graph snapshot and diagnostics produced by internal service correlation.
    /// </summary>
    public sealed class InternalServiceIntegrationExtractionResult
    {
        ...
        {
            // The result mirrors other external-integration slices so orchestration can merge snapshots without a special internal-service contract.
