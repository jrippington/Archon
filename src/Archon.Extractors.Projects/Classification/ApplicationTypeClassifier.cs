...
{
    /// <summary>
    /// Classifies supported .NET project files into deterministic high-level application categories for WP005 graph metadata.
    /// </summary>
    internal sealed class ApplicationTypeClassifier
    {
        ...
        {
            // WP005 inspects only small textual source/configuration files and avoids binaries, generated outputs, packages, and build artifacts with executable behavior.
