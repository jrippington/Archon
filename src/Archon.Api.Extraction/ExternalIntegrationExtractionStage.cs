...
{
    /// <summary>
    /// Runs the external integration external integration extraction foundation slice as part of the API-triggered extraction pipeline.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ExternalIntegrationExtractionStage : IExtractionStage
    {
        /// <summary>
        ...
        /// <summary>
        /// Stores the logger used for credential-safe external integration orchestration events.
        /// </summary>
        private readonly ILogger<ExternalIntegrationExtractionStage> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalIntegrationExtractionStage" /> class.
        /// </summary>
        /// <param name="logger">The logger used for stage start, completion, cancellation, and degraded extraction messages.</param>
        public ExternalIntegrationExtractionStage(ILogger<ExternalIntegrationExtractionStage> logger)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalIntegrationExtractionStage" /> class with explicit dependencies.
        /// </summary>
        ...
        public ExternalIntegrationExtractionStage(ExternalIntegrationFoundationExtractor extractor, IExternalIntegrationObservationProvider observationProvider, ILogger<ExternalIntegrationExtractionStage> logger)
        {
        ...
        /// <returns>A successful stage result when external integration foundation extraction completes or degrades non-fatally.</returns>
        public async Task<ExtractionStageResult> ExecuteAsync(ExtractionStageContext context, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation(
                "Starting external integration external integration extraction for run {RunId} with {SolutionCount} submitted solution path(s).",
            ...
            _logger.LogInformation(
                "Completed external integration external integration extraction for run {RunId}; projected {ObservationCount} observation(s), {NodeCount} node(s), {EdgeCount} edge(s), and {EvidenceCount} evidence record(s).",
                context.Run.RunId.ToString(),
