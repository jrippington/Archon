...
{
    /// <summary>
    /// Runs the UI/client Blazor route and component extraction slice as part of API-triggered extraction orchestration.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class BlazorRouteComponentExtractionStage : IExtractionStage
    {
        /// <summary>
        ...
        /// <summary>
        /// Stores the logger used for credential-safe UI/client orchestration diagnostics.
        /// </summary>
        private readonly ILogger<BlazorRouteComponentExtractionStage> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="BlazorRouteComponentExtractionStage" /> class.
        /// </summary>
        ...
        public BlazorRouteComponentExtractionStage(BlazorRouteComponentExtractor extractor, ILogger<BlazorRouteComponentExtractionStage> logger)
        {
        ...
        {
            // UI/client is non-blocking because absence of Blazor artifacts or partial Razor content should not prevent other extraction facts from being persisted.
            ArgumentNullException.ThrowIfNull(context);
            cancellationToken.ThrowIfCancellationRequested();

            _logger.LogInformation(
                "Starting UI/client Blazor route and component extraction for run {RunId}.",
            ...
            _logger.LogInformation(
                "Completed UI/client Blazor route and component extraction for run {RunId}; added {NodeCount} node(s), {EdgeCount} edge(s), {EvidenceCount} evidence record(s), {WarningCount} warning(s), and {ErrorCount} error(s) after stable-key deduplication.",
                context.Run.RunId.ToString(),
