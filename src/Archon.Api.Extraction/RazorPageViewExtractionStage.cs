...
{
    /// <summary>
    /// Runs the UI/client Razor Pages and MVC Razor extraction slice as part of API-triggered extraction orchestration.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class RazorPageViewExtractionStage : IExtractionStage
    {
        /// <summary>
        ...
        /// <summary>
        /// Stores the logger used for credential-safe UI/client Razor orchestration diagnostics.
        /// </summary>
        private readonly ILogger<RazorPageViewExtractionStage> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="RazorPageViewExtractionStage" /> class.
        /// </summary>
        ...
        public RazorPageViewExtractionStage(RazorPageViewExtractor extractor, ILogger<RazorPageViewExtractionStage> logger)
        {
        ...
        {
            // UI/client Razor extraction is non-blocking because absence of `.cshtml` artifacts or partial markup should not prevent other extraction facts from being persisted.
            ArgumentNullException.ThrowIfNull(context);
            cancellationToken.ThrowIfCancellationRequested();

            _logger.LogInformation(
                "Starting UI/client Razor Pages and MVC Razor extraction for run {RunId}.",
            ...
            _logger.LogInformation(
                "Completed UI/client Razor Pages and MVC Razor extraction for run {RunId}; added {NodeCount} node(s), {EdgeCount} edge(s), {EvidenceCount} evidence record(s), {WarningCount} warning(s), and {ErrorCount} error(s) after stable-key deduplication.",
                context.Run.RunId.ToString(),
