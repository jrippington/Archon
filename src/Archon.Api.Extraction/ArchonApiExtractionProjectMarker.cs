...
{
    /// <summary>
    /// Identifies the Archon.Api.Extraction project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonApiExtractionProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonApiExtractionProjectMarker"/> class.
        /// </summary>
        public ArchonApiExtractionProjectMarker()
        {
