...
{
    /// <summary>
    /// Runs the WP011 WinUI XAML and packaging extraction slice as part of API-triggered extraction orchestration.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class Wp011WinUiXamlExtractionStage : IExtractionStage
    {
        /// <summary>
        ...
        /// <summary>
        /// Stores the logger used for credential-safe WP011 WinUI orchestration diagnostics.
        /// </summary>
        private readonly ILogger<Wp011WinUiXamlExtractionStage> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="Wp011WinUiXamlExtractionStage" /> class.
        /// </summary>
        ...
        public Wp011WinUiXamlExtractionStage(WinUiXamlExtractor extractor, ILogger<Wp011WinUiXamlExtractionStage> logger)
        {
        ...
        {
            // WP011 WinUI extraction is non-blocking because absence of WinUI artifacts should not prevent other extraction facts from being persisted.
            ArgumentNullException.ThrowIfNull(context);
            cancellationToken.ThrowIfCancellationRequested();

            _logger.LogInformation(
                "Starting WP011 WinUI XAML extraction for run {RunId}.",
            ...
            _logger.LogInformation(
                "Completed WP011 WinUI XAML extraction for run {RunId}; added {NodeCount} node(s), {EdgeCount} edge(s), {EvidenceCount} evidence record(s), {WarningCount} warning(s), and {ErrorCount} error(s) after stable-key deduplication.",
                context.Run.RunId.ToString(),
