...
namespace Archon.Api.Extraction
{
    ...
    public static class ExtractionApiServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddArchonExtractionApi(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IExtractionStage, AspNetCoreRuntimeExtractionStage>();
            services.AddSingleton<IExtractionStage, DataAccessExtractionStage>();
            ...
            services.AddSingleton<IExtractionStage, ExternalIntegrationExtractionStage>();
            ...
            services.AddSingleton<BlazorRouteComponentExtractionStage>();
            services.AddSingleton<RazorPageViewExtractionStage>();
            services.AddSingleton<WinFormsStaticUiExtractionStage>();
            services.AddSingleton<WpfXamlExtractionStage>();
            services.AddSingleton<WinUiXamlExtractionStage>();
            services.AddSingleton<MauiXamlExtractionStage>();
            services.AddSingleton<AvaloniaAxamlExtractionStage>();
            services.AddSingleton<IExtractionStage, UiClientExtractionStage>();
