...
namespace Archon.Extractors.DataAccess.AdoNet
{
    ...
    public sealed class AdoNetRawSqlExtractor
    {
        ...
        {
            // ADO.NET extraction runs in the same WP009 path as LINQ to SQL and EF so callers receive one deterministic data-access snapshot.
        ...
        {
            // Token-based extraction intentionally handles only common single-statement shapes required by WP009.
        ...
        {
            // Provider values align with WP009 metadata vocabulary while keeping abstract Db* APIs provider-neutral.
        ...
        {
            // These are the WP009-required execution APIs; Fill is included because DataAdapter executes its select command.
        ...
        {
            // Shared metadata keeps ADO.NET facts aligned with WP009 lower-camel naming and source provenance rules.
