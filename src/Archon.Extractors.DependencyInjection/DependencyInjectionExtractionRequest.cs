...
namespace Archon.Extractors.DependencyInjection
{
    ...
    /// </summary>
    /// <remarks>
    /// The request deliberately stays small for the first WP007 slice. It supplies one semantic document and the snapshot stable key that scopes graph facts, while later work items can extend orchestration without replacing this entry model.
    /// </remarks>
