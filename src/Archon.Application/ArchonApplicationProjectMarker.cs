...
{
    /// <summary>
    /// Identifies the Archon.Application project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonApplicationProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonApplicationProjectMarker"/> class.
        /// </summary>
        public ArchonApplicationProjectMarker()
        {
