...
namespace Archon.Extractors.AspNet.Runtime
{
    ...
    public sealed class ConsoleEntryPointRuntimeExtractor
    {
        ...
        {
            // CONTAINS is the established graph relationship for project/type/method hierarchy; runtime role metadata marks why this edge was emitted by WP008.
        ...
        {
            // WP008 entry-point identity uses project plus method identity, or project plus normalized top-level-statement file path for implicit Main.
