...
namespace Archon.Extractors.AspNet.MinimalApis
{
    ...
    public sealed class AspNetCoreMinimalApiEndpointExtractor
    {
        ...
        {
            // The source is the controller for controller actions and the project for minimal APIs, matching WP008 relationship direction.
            GraphMetadata metadata = GraphMetadata.From(new Dictionary<string, object?>
            {
        ...
        {
            // WP008 scopes runtime controller identity by project plus fully qualified controller type name.
        ...
        {
            // The key shape follows WP008 by including project identity, route, method, and handler identity without machine paths or enumeration order.
