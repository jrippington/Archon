...
{
    /// <summary>
    /// Identifies the Archon.Api.Query project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonApiQueryProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonApiQueryProjectMarker"/> class.
        /// </summary>
        public ArchonApiQueryProjectMarker()
        {
