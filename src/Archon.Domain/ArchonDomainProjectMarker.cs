namespace Archon.Domain
{
    /// <summary>
    /// Identifies the Archon.Domain project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonDomainProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonDomainProjectMarker"/> class.
        /// </summary>
        public ArchonDomainProjectMarker()
        {
