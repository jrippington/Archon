...
{
    /// <summary>
    /// Describes an endpoint, controller, method, and project ownership fact produced by earlier extraction slices and consumed by WP010 internal service correlation.
    /// </summary>
