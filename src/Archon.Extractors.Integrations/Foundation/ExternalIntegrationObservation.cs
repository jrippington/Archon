...
{
    /// <summary>
    /// Describes one evidence-backed external integration observation ready for graph projection by the WP010 foundation extractor.
    /// </summary>
    /// <remarks>
    /// Later WP010 detector work items can create observations from HTTP, REST, messaging, storage, email, payment, and generated-client evidence while this foundation type keeps graph projection consistent.
    /// </remarks>
