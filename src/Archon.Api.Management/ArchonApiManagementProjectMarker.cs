...
{
    /// <summary>
    /// Identifies the Archon.Api.Management project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonApiManagementProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonApiManagementProjectMarker"/> class.
        /// </summary>
        public ArchonApiManagementProjectMarker()
        {
