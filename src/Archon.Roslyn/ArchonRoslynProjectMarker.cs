namespace Archon.Roslyn
{
    /// <summary>
    /// Identifies the Archon.Roslyn project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonRoslynProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonRoslynProjectMarker"/> class.
        /// </summary>
        public ArchonRoslynProjectMarker()
        {
