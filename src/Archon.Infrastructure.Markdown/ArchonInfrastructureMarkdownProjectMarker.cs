namespace Archon.Infrastructure.Markdown
{
    /// <summary>
    /// Identifies the Archon.Infrastructure.Markdown project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonInfrastructureMarkdownProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonInfrastructureMarkdownProjectMarker"/> class.
        /// </summary>
        public ArchonInfrastructureMarkdownProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Infrastructure.Markdown";
        }
    }
}
