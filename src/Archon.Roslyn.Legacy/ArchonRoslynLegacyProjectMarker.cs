...
{
    /// <summary>
    /// Identifies the Archon.Roslyn.Legacy project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonRoslynLegacyProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonRoslynLegacyProjectMarker"/> class.
        /// </summary>
        public ArchonRoslynLegacyProjectMarker()
        {
