...
{
    /// <summary>
    /// Extracts WP011 Avalonia AXAML, view-locator, ReactiveUI, navigation, and dependency facts from repository source into shared graph contracts.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class AvaloniaAxamlExtractor
    {
        ...
        {
            // Unknown extraction focuses on runtime patterns called out by WP011 rather than attempting to model every Avalonia dynamic feature.
        ...
        {
            // Metadata uses shared WP011 artifact names rather than Avalonia-specific graph node kinds.
