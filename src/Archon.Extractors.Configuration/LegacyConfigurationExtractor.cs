...
{
    /// <summary>
    /// Extracts legacy XML configuration files and compiler-bound ConfigurationManager usage into WP002 graph contracts.
    /// </summary>
    public sealed class LegacyConfigurationExtractor
    {
        ...
        {
            // Type endpoints keep the legacy configuration slice aligned with WP002 reusable node kinds.
