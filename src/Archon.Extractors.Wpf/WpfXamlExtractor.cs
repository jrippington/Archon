...
{
    /// <summary>
    /// Extracts WP011 WPF XAML facts from project files, XAML markup, and code-behind source into shared graph contracts.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class WpfXamlExtractor
    {
        ...
        {
            // Unknown extraction focuses on runtime patterns called out by WP011 rather than attempting to model every WPF dynamic feature.
        ...
        {
            // Metadata uses shared WP011 artifact names rather than WPF-specific graph node kinds.
