...
{
    /// <summary>
    /// Identifies the Archon.Roslyn.VisualBasic project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonRoslynVisualBasicProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonRoslynVisualBasicProjectMarker"/> class.
        /// </summary>
        public ArchonRoslynVisualBasicProjectMarker()
        {
        ...
        public string GetProjectName()
        {
            ...
            return "Archon.Roslyn.VisualBasic";
        }
    }
}
