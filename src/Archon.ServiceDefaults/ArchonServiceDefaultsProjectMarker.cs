...
{
    /// <summary>
    /// Identifies the Archon.ServiceDefaults project in the WP001 solution skeleton.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public sealed class ArchonServiceDefaultsProjectMarker
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchonServiceDefaultsProjectMarker"/> class.
        /// </summary>
        public ArchonServiceDefaultsProjectMarker()
        {
