...
{
    /// <summary>
    /// Verifies the WP010 external integration stage participates in API-triggered extraction orchestration.
    /// </summary>
    public sealed class Wp010ExternalIntegrationExtractionStageTests
    {
        /// <summary>
        /// Verifies API module registration includes the WP010 stage in the extraction pipeline.
        /// </summary>
        [Fact]
        public void AddArchonExtractionApi_ShouldRegisterWp010IntegrationStage()
        {
            ...
            Assert.Contains(stages, stage => stage is Wp010ExternalIntegrationExtractionStage);
        ...
        public async Task ExecuteAsync_WhenNoIntegrationEvidenceExists_ShouldCompleteWithoutFacts()
        {
            ...
            Wp010ExternalIntegrationExtractionStage stage = new(NullLogger<Wp010ExternalIntegrationExtractionStage>.Instance);
        ...
        public async Task ExecuteAsync_WhenObservationProviderContributesEvidence_ShouldAccumulateIntegrationFacts()
        {
            ...
            Wp010ExternalIntegrationExtractionStage stage = new(
                new ExternalIntegrationFoundationExtractor(),
                new StaticExternalIntegrationObservationProvider([observation]),
                NullLogger<Wp010ExternalIntegrationExtractionStage>.Instance);
            ExtractionStageContext context = CreateContext();
        ...
        private static ExtractionStageContext CreateContext()
        {
            ...
            ExtractionRun run = new(
                ...
                completedUtc: null,
                new ExtractionRunProgress("Queued", "Queued for WP010 stage test.", 0, new DateTimeOffset(2026, 5, 20, 8, 0, 0, TimeSpan.Zero)),
                warnings: null,
                errors: null,
