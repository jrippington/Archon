...
{
    /// <summary>
    /// Verifies the WP009 Entity Framework extraction slice for EF6, EF Core, mapping facts, migrations, providers, source usage, raw SQL, warnings, unknowns, and redaction.
    /// </summary>
    public sealed class EntityFrameworkExtractorTests
    {
        ...
        {
            // Redaction is a WP009 safety requirement because source fixtures may contain connection-string literals that look like real credentials.
