...
{
    /// <summary>
    /// Verifies the WP009 ADO.NET and raw SQL extraction slice for provider APIs, commands, stored procedures, read/write hints, dynamic SQL, affected tables, evidence, confidence, unknowns, and redaction.
    /// </summary>
    public sealed class AdoNetRawSqlExtractorTests
    {
        ...
        {
            // Redaction is a WP009 safety requirement because source fixtures may contain SQL and connection-string literals that look like real credentials.
