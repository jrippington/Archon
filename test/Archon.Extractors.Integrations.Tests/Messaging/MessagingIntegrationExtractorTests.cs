...
namespace Archon.Extractors.Integrations.Tests.Messaging
{
    /// <summary>
    /// Verifies that the WP010 messaging extractor turns static broker, handler, and abstraction evidence into safe graph facts.
    /// </summary>
