...
namespace Archon.Extractors.Integrations.Tests.HttpRest
{
    /// <summary>
    /// Verifies that the WP010 HTTP and REST extractor turns deterministic outbound client evidence into safe graph facts.
    /// </summary>
