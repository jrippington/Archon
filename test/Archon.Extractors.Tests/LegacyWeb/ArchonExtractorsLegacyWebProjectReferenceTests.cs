...
namespace Archon.Extractors.Tests.LegacyWeb
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests LegacyWeb category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsLegacyWebProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.LegacyWeb category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
