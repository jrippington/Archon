...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests DataAccess category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsDataAccessProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.DataAccess category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
