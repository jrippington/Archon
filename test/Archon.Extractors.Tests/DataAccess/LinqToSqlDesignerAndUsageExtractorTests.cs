...
{
    /// <summary>
    /// Verifies the LINQ to SQL designer and source-usage extraction slice for generated model code, method-level usage, raw SQL, stored procedure wrappers, and unknowns.
    /// </summary>
