...
namespace Archon.Extractors.Tests.Maui
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests Maui category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsMauiProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.Maui category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
