...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests Razor category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsRazorProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.Razor category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
