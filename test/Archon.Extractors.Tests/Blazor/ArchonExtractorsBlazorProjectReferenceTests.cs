...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests Blazor category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsBlazorProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.Blazor category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
