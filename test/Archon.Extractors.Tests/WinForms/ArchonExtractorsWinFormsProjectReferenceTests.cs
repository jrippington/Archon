...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests WinForms category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsWinFormsProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.WinForms category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
