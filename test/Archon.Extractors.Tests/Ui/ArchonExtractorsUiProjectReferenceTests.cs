...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests Ui category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsUiProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.Ui category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
