...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests WinUI category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsWinUIProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.WinUI category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
