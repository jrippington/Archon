...
namespace Archon.Extractors.Tests.Integrations.Rpc
{
    /// <summary>
    /// Verifies that the RPC and generated-client extractor turns WCF, SOAP/ASMX, and gRPC static evidence into safe graph facts.
    /// </summary>
