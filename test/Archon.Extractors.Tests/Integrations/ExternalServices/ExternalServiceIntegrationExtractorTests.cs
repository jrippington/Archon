...
namespace Archon.Extractors.Tests.Integrations.ExternalServices
{
    /// <summary>
    /// Verifies that the storage, SMTP/email, and payment-provider extractor emits safe external-service graph facts.
    /// </summary>
