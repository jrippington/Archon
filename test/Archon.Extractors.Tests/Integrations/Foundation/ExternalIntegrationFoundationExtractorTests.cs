...
namespace Archon.Extractors.Tests.Integrations.Foundation
{
    /// <summary>
    /// Verifies the minimal integration foundation extractor projects explicit evidence into graph facts safely.
    /// </summary>
    public sealed class ExternalIntegrationFoundationExtractorTests
    {
        ...
        {
            // The foundation slice must be safe to run before later integration detectors contribute integration observations.
