...
{
    /// <summary>
    /// Verifies the Archon.Extractors.Tests AspNet category can load its corresponding production assembly.
    /// </summary>
    public sealed class ArchonExtractorsAspNetProjectReferenceTests
    {
        /// <summary>
        /// Confirms the Archon.Extractors.AspNet category is available from the consolidated production project and exposes loadable assembly metadata.
        /// </summary>
        [Fact]
